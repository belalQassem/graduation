import { Card, List ,Image, Rate,Spin,Select, Typography, message,Badge, Button} from 'antd';
...
// dataSource={items}<Card
//     className="itemCard"
//     title={Proudects.title}
//     key={index}
//     cover={
//       <Image className="itemCardImage" src={Proudects.thumbnail} />
//     }
//     actions={[
//       <Rate allowHalf disabled value={Proudects.rating} />,
//       <AddToCartButton item={Proudects} />,
//     ]}  <AddToCartButton item={Proudects} />,
//   ></Card>